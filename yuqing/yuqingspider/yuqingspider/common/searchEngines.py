...
SearchEngines = {
    "xinhua_net": "http://news.chinaso.com/newssearch.htm?q={0}&page={1}",
    "zhongxin_net": "http://news.so.com/ns?q=site%3Achinanews.com+{0}&pn={1}&tn=news&rank=rank&j=0&src=page",
    "xinjingbao": "http://www.bjnews.com.cn/search.php?type=1&sk={0}&page={1}",
    "fenghuang_net": "http://search.ifeng.com/sofeng/search.action?q={0}&c=1&p={1}",
    "caijing_net":"http://search.caijing.com.cn/search.jsp?Page={0}&type=0&item=3&range=0&key={1}&Domain=-msn&orderField=0",
    "cctv": "http://search.cctv.com/search.php?qtext={0}&type=web&page={1}&datepid=1&vtime=-1&sort=relevance",
    "zhongqing_net": "http://search.youth.cn/cse/search?q={0}&p={1}&s=6006151520371175686",
    "guangming_net": "http://zhannei.baidu.com/cse/search?q={0}&p={1}&s=6995449224882484381",
    "huanqiu_net": "http://s.huanqiu.com/s/?q={0}&p={1}",
    "jingjiguancha_net": "http://app.eeo.com.cn/?app=search&controller=index&action=searchall&w={0}&p={1}",


    'baidu_class': 'http://news.baidu.com/ns?word={0}&pn={1}&cl=2&ct=1',
    'baidu': 'http://news.baidu.com/ns?word={0}&pn={1}&clk=sortbytime&ct=0&clk=sortbytime',
    ...
    '010':'http://bbs.010.cc/search.php?mod=forum&searchid={2}&orderby=dateline&ascdesc=desc&searchsubmit=yes&kw={0}&page={1}',
    'xinhua': 'http://news.chinaso.com/newssearch.htm?q={0}&page={1}'
}


SearchEngineResultSelectors = {
    'medicine': {'block': '//tbody/tr/td[@height="30"]', 'info': "//a/text()"},

    'xinhua_net': {'block': '//li[@class="reItem "]', 'link': 'h2/a/@href', 'title': 'h2/a/text()', 'from': './/p[@class="snapshot"]/span/text()', 'abstract': 'string(div[contains(@class, "reNewsWrapper")]/div/p/text())', 'time_location':0},
    'zhongxin_net': {'block': '//li[contains(@class,"res-list")]', 'link': './/h3/a/@href', 'title': './/h3/a/text()', 'from': './/span[@class="sitename"]/text()', 'time':'.//span[@class="posttime"]/@data-pdate', 'abstract':'string(.//p[@class="content"])'},
    'xinjingbao': {'block': '//div[@class="news"]', 'link': './/dd/a/@href', 'title': './/dd/a/text()', 'time':'.//dl/dt/text()', 'abstract': 'string(.//p[@class="txt"])'},
    'fenghuang_net': {'block': '//div[@class="searchResults"]', 'link': './/p[@class="fz16 line24"]/a/@href', 'title': ['.//p[@class="fz16 line24"]'], 'from': './/p/font[@color="#1a7b2e"]/text()', 'time_location': 1, 'abstract': ['p']},
    'caijing_net': {'block': '//div[@class="searchxt"]', 'link': './/a/@href', 'title': './/a/text()', 'time': './/span/text()', 'abstract': './/p/text()', 'reverse':1},
    'cctv': {'block': '//ul[@id="ccd"]/li', 'link': './/h3/a/@href', 'title': ['.//h3/a'], 'time': './/span[@style="float:right"]/text()', 'abstract': ['p']},
    'zhongqing_net': {'block': '//div[@class="result f s0"]', 'link': './/h3[@class="c-title"]/a/@href', 'title': './/h3[@class="c-title"]/a/text()', 'time': './/div/span[@class="c-showurl"]/text()', 'abstract': ".//div[@class='c-abstract']/text()"},
    'guangming_net': {'block': '//div[@class="result f s0"]', 'link': './/h3[@class="c-title"]/a/@href', 'title': './/h3[@class="c-title"]/a/text()', 'time': './/div/span[@class="c-showurl"]/text()', 'abstract': ".//div[@class='c-abstract']/text()"},
    'huanqiu_net': {'block': '//li[contains(@class,"dotLightBot")]', 'link': './/a/@href', 'title': './/a/@title', 'time': './/dl/dd/span[@class="link"]/text()', 'abstract': ".//dl/dd/p/text()"},


    'people_net': {'block': '//div[@class="result"]', 'link': 'h3/a/@href', 'title': 'h3/a/text()', 'from': './/p[@class="c-author"]/text()', 'abstract':['string(div[contains(@class, "c-summary")]/text())', './/div/div[2]/text()']},
    'china_net': {'block': '//div[@class="result"]', 'link': 'h3/a/@href', 'title': 'h3/a/text()', 'from': './/p[@class="c-author"]/text()', 'abstract':['string(div[contains(@class, "c-summary")]/text())', './/div/div[2]/text()']},
    'baidu':{ 'block': '//div[@class="result"]', 'link': 'h3/a/@href', 'title': 'h3/a/text()', 'from': './/p[@class="c-author"]/text()', 'abstract':['string(div[contains(@class, "c-summary")]/text())', './/div/div[2]/text()']},
